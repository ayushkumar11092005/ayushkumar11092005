...
#### 🤖 1. AI Chatbot for College Queries
> An AI-driven interactive chatbot designed to resolve student queries regarding campus infrastructure, course details, admission procedures, and schedules efficiently.
...
> A smart application that evaluates resumes against job descriptions, provides keyword optimization suggestions, and calculates compatibility scores using Natural Language Processing.
